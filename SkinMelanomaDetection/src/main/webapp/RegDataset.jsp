...
<div class="col-md-6">
<div ><center><h2>Register Covid Symptoms Dataset</h2></center><br/>
 <form id="frm" action="http://localhost:80/CovidDetection/SaveDataSet.py" method="post"  enctype="multipart/form-data">
