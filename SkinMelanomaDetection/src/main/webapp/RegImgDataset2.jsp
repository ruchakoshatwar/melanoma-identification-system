...
<div class="col-md-6">
<div ><center><h2>Register Melanoma Categories Images Dataset</h2></center><br/>
 <form id="frm" action="http://localhost:80/SkinMelanomaDetectionPython/multiPhotosHandler1.py" method="post"  enctype="multipart/form-data">
